...
export default function ClosingSection() {
  ...
  return (
    <section id={section.id} className="py-16 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto border-t border-[#C86D7C]/15 text-center">
      ...
      <div className="space-y-5 sm:space-y-8 max-w-2xl mx-auto mb-10 sm:mb-14">
