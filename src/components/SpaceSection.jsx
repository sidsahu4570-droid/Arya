  ...
  return (
    <section id={section.id} className="py-12 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto border-t border-[#C86D7C]/15">
      ...
      <motion.div
        ...
        className="max-w-3xl mx-auto my-6 sm:my-10 py-6 border-y border-[#C86D7C]/20 text-center relative px-4"
      >
        <p className="font-serif-cormorant italic text-3xl sm:text-5xl text-[#231F20] leading-relaxed whitespace-pre-line mb-4 font-normal">
          {section.quote}
        </p>
      ...
      <div className="max-w-3xl mx-auto divide-y divide-[#C86D7C]/15 my-8 sm:my-12">
        {section.comparisons.map((item, idx) => (
          <motion.div
            ...
            className="py-4 sm:py-5 grid grid-cols-1 md:grid-cols-12 items-center gap-2 sm:gap-4 text-center md:text-left"
          >
            <div className="md:col-span-5 text-center md:text-right md:pr-4">
