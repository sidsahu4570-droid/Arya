  ...
  return (
    <section id={section.id} className="py-24 sm:py-36 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto border-t border-[#C86D7C]/15">
      ...
      <div className="text-center max-w-3xl mx-auto mb-20 sm:mb-32">
        ...
        <div className="max-w-3xl mx-auto my-14 py-8 border-y border-[#C86D7C]/20 text-center">
      ...
      */}
      <div className="pt-8 sm:pt-16">
        ...
        {car1 && (
          <motion.div
            ...
            className="my-24 sm:my-36 text-left max-w-2xl"
          >
        ...
        {car4 && (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="my-36 sm:my-56 max-w-2xl mx-auto text-center py-12 border-y border-[#C86D7C]/15"
          >
            <span className="font-handwriting text-2xl text-[#8C827E] block mb-2">
              {car4.tag}
            </span>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
        className="text-center max-w-2xl mx-auto mt-24 sm:mt-36 pt-12 border-t border-[#C86D7C]/15"
      >
