  ...
  return (
    <section id="my-family" className="section-container">
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto', textAlign: 'center' }}>
        <span className="handwritten-note mb-2" style={{ fontSize: '1.6rem', color: 'var(--accent-rose)' }}>
          ♡ "This is the home I come from."
        </span>

        <h3 className="font-serif text-gradient-rose" style={{ fontSize: '1.75rem', margin: '0.75rem 0 1.75rem', fontWeight: 400 }}>
          I grew up in a joint family.
        </h3>

        {/* Floating Family Member Notes */}
          ...
          {familyMembers.map((member, idx) => (
            <span
              ...
              style={{
                ...
                border: '1px stroke rgba(217, 107, 131, 0.25)',
                color: 'var(--text-deep)'
              }}
            >
              {member}
