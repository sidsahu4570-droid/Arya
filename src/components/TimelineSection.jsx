  ...
  return (
    <section id={section.id} className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto border-t border-[#C86D7C]/15">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-24">
        ...
        <p className="font-sans-jakarta text-base sm:text-lg text-[#584F4C] leading-relaxed max-w-2xl mx-auto mb-12">
          {section.intro}
        </p>
      ...
      {section.instagramStory && (
        <motion.div
          ...
          className="my-20 py-14 border-t border-b border-[#C86D7C]/20 text-center"
        >
          {/* Header & Subheading */}
          ...
          <div className="max-w-2xl mx-auto space-y-10 sm:space-y-14 my-14 text-left px-4">
            {/* Moment 1 */}
            <motion.div
      ...
      <div className="pt-12 sm:pt-20">
        ...
        {m3 && (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="my-24 sm:my-36 max-w-xl mx-auto text-center py-12 border-y border-[#C86D7C]/15"
          >
        ...
        {m4 && (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="my-20 sm:my-32 text-left max-w-lg sm:pl-10"
          >
        ...
        {m5 && (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="my-24 sm:my-36 md:ml-12 max-w-2xl text-left"
          >
        ...
        {m6 && (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="my-24 sm:my-36 max-w-2xl mx-auto text-center"
          >
        ...
        {m7 && (
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="mt-24 sm:mt-36 mb-16 max-w-2xl mx-auto text-center py-16 border-t border-[#C86D7C]/20"
          >
